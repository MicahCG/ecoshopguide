...
export default function DormCollection() {
  ...
  usePageSEO({ title: "Dorm Decor | EcoShopGuide", description: "Warm boho dorm decor and organization, curated for small spaces.", canonical: "https://www.ecoshopguide.com/shop-the-look/dorm" });
